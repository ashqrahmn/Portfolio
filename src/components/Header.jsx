    ...
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4 relative 2xl:gap-6">
      ...
      >
        <img
          ...
          alt="Profile"
          className="rounded-full w-32 2xl:w-40"
        />
      </motion.div>
      ...
      <motion.h3
        ...
        className="flex items-end gap-2 text-xl md:text-2xl 2xl:text-3xl font-ovo"
      >
      ...
      <motion.h1
        ...
        className="text-3xl sm:text-6xl lg:text-[66px] 2xl:text-[80px] font-ovo flex justify-center"
      >
        {text === "" ? "\u00A0" : text}
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-4 2xl:gap-6">
        <motion.a
          ...
          href="#contact"
          className={`px-10 py-3 2xl:px-12 2xl:py-4 border rounded-full flex items-center gap-2 border-white text-white ${
        ...
        <motion.a
          ...
          download
          className={`group px-10 py-3 2xl:px-12 2xl:py-4 border rounded-full border-gray-500 flex items-center gap-2 transition-all duration-300 ${
